import { Box, Boxes, Building2 } from "lucide-react";
...
export default function Supplier() {
  return (
    <div className="supplier-container">
      <h1 className="text-3xl shadow p-3 my-6">Re-odering list by supplier</h1>
                  ...
                  >
                    <div className="variant-details">
                      ...
                      <p className="text-sm text-gray-600">
                        Restock Date:
                        {new Date(variant.restockDate).toLocaleString()}
                      </p>
                    </div>
