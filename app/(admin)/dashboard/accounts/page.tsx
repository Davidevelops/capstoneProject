                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        required
                        className={`w-full px-4 py-3 bg-white/80 backdrop-blur-sm border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 outline-none ${
                          createPasswordError
